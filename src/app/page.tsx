...
export default async function LandingPage() {
  ...
  const WA_LINK = 'https://wa.me/5541992852559?text=Quero%20saber%20mais%20sobre%20o%20app%20Empresa%20de%20Cestas'
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="mt-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold text-base px-6 py-3 rounded-2xl transition-colors"
            >
              <WhatsAppIcon />
              Saiba mais pelo WhatsApp
            </a>
